...
/* ARMCC -c -asm -o CH375HF9.O CH375HF9.C -ISRC\ */
/* ARMLINK -o CH375HFT.AXF -scatter SRC\LPC2114.SCF -entry 0 CH375HFT.O SRC\STARTUP.O SRC\HEAP.O SRC\STACK.O CH375HF9.LIB */
/* FROMELF -bin -o CH375HFT.BIN CH375HFT.AXF */
...
#define CH375_INT_WIRE			( IO0PIN & 0x08 )	/* P0.3, CH375的中断线INT#引脚,连接CH375的INT#引脚,用于查询中断状态 */
...
void CH375_PORT_INIT( )  /* 由于使用通用I/O模拟并口读写时序,所以进行初始化 */
{
